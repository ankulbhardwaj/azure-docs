...
3. Finally, run the following cmdlet with `<PackageFamilyName>` replaced by the **PackageFamilyName** you found in the previous step:
   ...
   ```powershell
   New-AzWvdApplication -Name <applicationname> -ResourceGroupName <resourcegroupname> -G![appGroupname](https://user-images.githubusercontent.com/86134788/127274131-8bb6cd94-7737-4f59-a970-f7bea677248c.PNG)
